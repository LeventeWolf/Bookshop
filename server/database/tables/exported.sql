...
SET DEFINE OFF;
Insert into WOLF.ADDRESS (ID,CITY,ZIPCODE,STREET,HOUSE_NUMBER) values (1,'szeged',6725,'Répás',12);
Insert into WOLF.ADDRESS (ID,CITY,ZIPCODE,STREET,HOUSE_NUMBER) values (2,'Budapest',4000,'Sajt',10);
...
--------------------------------------------------------
--  Constraints for Table FLIM
--------------------------------------------------------

  ALTER TABLE "WOLF"."FLIM" MODIFY ("ID" NOT NULL ENABLE);
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "WOLF"."CUSTOMER" ADD CONSTRAINT "CUSTOMER_FK1" FOREIGN KEY ("USERNAME")
	  REFERENCES "WOLF"."CLIENT" ("USERNAME") ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table FLIM
--------------------------------------------------------

  ALTER TABLE "WOLF"."FLIM" ADD CONSTRAINT "FLIM_FK1" FOREIGN KEY ("ID")
	  REFERENCES "WOLF"."PRODUCT" ("ID") ON DELETE CASCADE ENABLE;
--------------------------------------------------------
